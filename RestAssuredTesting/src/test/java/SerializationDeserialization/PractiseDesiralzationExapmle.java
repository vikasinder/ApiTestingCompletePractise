...
public class PractiseDesiralzationExapmle {

	@org.testng.annotations.Test
	public void Test()
	{
		
		// ARRAYLIST IS USED TO GET THE RETUREND VALUES
		// AS YOU ARE NEVER SURE HOW MANY VALUES YOU GET IN RESPONSE
		// SO IF YOU ARE NOT SURE ABOUT VALUES YOU GET IN RESPONSE USE ARRAYLIST
		// AS ARRAYS ARE STATIC , AND ARRAYLIST ARE DYNAMIC - INCREASES IN SIZE ACCORDING TO VALUES THAT ARE PUT INTO IT
	...
	for(int j=0; j<webAutomationValues.size(); j++)
	{
		retrievedValues.add(webAutomationValues.get(j).getCourseTitle());
	}
	
	// change the array you made to arraylist
	
	   List<String>	 actualValues =	Arrays.asList(coursesWebautomation);
	   
	   Assert.assertTrue(actualValues.equals(retrievedValues));
